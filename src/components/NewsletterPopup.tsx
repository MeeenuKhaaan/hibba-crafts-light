...
export function NewsletterPopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/50 p-4">
      <div className="relative w-full max-w-md bg-background p-8 text-center shadow-soft">
        ...
        {done ? (
          ...
          <>
            ...
            >
              ...
              />
              <button className="bg-foreground px-5 text-[11px] uppercase tracking-luxury text-background">
                Subscribe
              </button>
            </form>
            <button
              onClick={close}
              className="mt-4 text-[11px] uppercase tracking-luxury text-muted-foreground hover:text-foreground"
            >
              No thanks
            </button>
          </>
