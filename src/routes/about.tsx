    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 py-20 text-center">
        ...
        <p className="mt-4 text-base leading-relaxed text-muted-foreground">
          Every wallet is cut from a single panel of full-grain leather. Every knife is hammered,
          ground, and balanced by a single maker. Each piece carries the mark of the hand that made it
          — and a lifetime repair promise from us.
        </p>
      </section>
